...
console.log(txt1.substr(8,2));

console.log(txt1.substring(2,7));
console.log(txt1.substring(8,10));

console.log(txt1.slice(2,7));
console.log(txt1.slice(8,10));
...
let txt3 = 'какой-либо текст :)';
function transformationText(n) {
    let text;
    if (txt3.length > n) {
        text = txt3.substr(0, n);
        text = text.concat('', '...');
        return text;
    } else {
        text = txt3;
...
let n = 10;
let result = transformationText(n);
console.log(result);
